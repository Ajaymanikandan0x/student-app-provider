  ...
  Future<void> _deleteDialog(BuildContext context) {
    return showDialog(
      ...
      builder: (context) => DeleteDialog(
        ...
        onDelete: () {
          Provider.of<DeleteStudentProvider>(context, listen: false)
              //error student.id fix it
